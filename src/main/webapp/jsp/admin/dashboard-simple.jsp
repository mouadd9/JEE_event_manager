                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach var="req" items="${pendingRequests}">
                                                <tr>
                                                    <td>${req.id}</td>
                                                    <td>${participantEmails[req.participantId]}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form method="post" action="${pageContext.request.contextPath}/admin/dashboard" style="display:inline;">
                                                            ...
                                                            <input type="hidden" name="requestId" value="${req.id}">
                                                            <input type="hidden" name="comment" value="Demande refusée par l'administrateur">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>Total de demandes en attente: <strong>${pendingRequests.size()}</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
