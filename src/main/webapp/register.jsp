...
<html lang="fr">
  <head>
    ...
    <!-- Google Fonts -->
    <link
      href="https://fonts.googleapis.com/css2?family=Neue+Plak:wght@400;600;700&display=swap"
      rel="stylesheet"
    />
          ...
          <div class="form-section active" id="step1">
            ...
            <div class="mb-4">
              ...
              <ul class="password-requirements mt-2">
                ...
                <li id="uppercase-req">
                  <i class="far fa-circle"></i> Une lettre majuscule
                </li>
                <li id="number-req">
                  <i class="far fa-circle"></i> Un chiffre
                </li>
              </ul>
            </div>
